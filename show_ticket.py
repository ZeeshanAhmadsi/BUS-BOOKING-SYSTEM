...
root.configure(bg='peachpuff',bd=0)
def on_close():
...
frame=LabelFrame(root,padx=5,borderwidth=0,bg='peachpuff')
frame.pack(padx=5)
image = PhotoImage(file="star.png")
Label(frame,image=image).pack()


frame2=LabelFrame(root,padx=5,pady=5,borderwidth=0,bg='peachpuff')
...
frame3=LabelFrame(root,padx=5,pady=5,borderwidth=5,relief="sunken",bg='peachpuff')
